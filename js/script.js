...
//Cluster Recruitment Click listener

$('.recruitment').on('click',function(){
    var Clicked = 'recruitment';
});
...
function onEachFeature(feature, layer) {
    console.log("on each feature was called");

    layer.bindPopup(feature.properties.Start_Date);
    ...
    $.getJSON('schools.geojson',function(data){
        ...
        //                           '<br />' + "Cluster Recruitment : " + feature.properties.cluster_recruitment + 
